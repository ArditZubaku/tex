...
internal/
  ...
  editor/               the loop: draw a frame, read a key, repeat
    ...
    find/               search, gd, gr, K, the symbols, the diagnostics, the project grep, the popup
